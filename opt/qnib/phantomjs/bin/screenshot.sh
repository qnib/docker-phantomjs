...
SCREEN_DELAY=${SCREENSHOT_DELAY=2000}
...
for TS in ${TS_ITER};do
  ...
  phantomjs /opt/qnib/phantomjs/bin/take_screenshot.js ${SCREEN_URL} ${SCREENSHOT_FILE_PATH}/${TIME_START}_t${TS}_${SCREENSHOT_NAME}.png ${SCREEN_DELAY} ${SCREENSHOT_TOKEN}
  ## Annotate TIMESTAMP
